...
public class DateUtils {
    ...
    public static String getPreviousAmericaDateTimeString() {
        return format(getStartDate(getAmericaLocalDateTime(getPreviousDateTime(null))));
    }
...
//        System.out.println(getAmericaLocalDateTime());
//        System.out.println(getAmericaLocalDate());
//        System.out.println(getStartDateAmerican());
//        System.out.println(getEndDateAmerican());

//        LocalDateTime localDateTime=LocalDateTime.now().plusHours(-6);
//        LocalDateTime localDateTime2=LocalDateTime.now().plusHours(4);
//        System.out.println(isLocalTimeRange(localDateTime,localDateTime2));
        System.out.println(getPreviousAmericaPayDate());
    }
...
//    }
    ...
    public static void isIllegalTime(LocalTime startDate,LocalTime endDate){
        if(startDate==null){
            throw new  IllegalArgumentException("startDate is null");
        }
        if(endDate==null){
...
//        }
    ...
    public static boolean isLocalTimeRange(LocalTime startDate, LocalTime endDate){
        isIllegalTime(startDate,endDate);
        LocalTime now=LocalTime.now();
        if(startDate.compareTo(now)<=0&&endDate.compareTo(now)>=0){
            return true;

...
public class MyBeanUtils {
    ...
    //对象转换成map
    public static <K,V>Map<K,V> copyMapToMap(Map<K,V> map,Class<K> keyClazz,Class<V> valueClazz) {
    ...
    //map的value转list
    public static <K,V>List<V> mapValueToList(Map<K,V> map,Class<K> keyClazz,Class<V> valueClazz) {

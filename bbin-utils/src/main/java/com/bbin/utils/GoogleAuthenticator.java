...
public class GoogleAuthenticator {  
    ...
    public static String genSecret() {  
        ...
        String qrBarcodeURL = GoogleAuthenticator.getQRBarcodeURL(user,
                host, secret);
        System.out.println("秘钥二维码："+qrBarcodeURL);
        return secret;  
    }  
    ...
    private static String user = "myFirstAccount";
    private static String host = "113.130.124.138";
    private static String secret = "IPFNNOJRR4BSNHVV";
    //账号
    public static void main(String[] args) {
        String secret = genSecret();
        System.out.println(secret);
        boolean flag = check_code_pre("IPFNNOJRR4BSNHVV", "425214", System.currentTimeMillis());
